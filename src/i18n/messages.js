...
export const messages = {
  en: {
    ...
    footer: {
      ...
      description:
        'A vibrant youth fellowship under the Foursquare Gospel Church, Mgbuoba Zonal HQ. Raising young people who know God and make Him known.',
      ...
      emailUpdatesDesc: 'Get event communication and ministry updates by email.',
      yourName: 'Your name',
      ...
      subscribeErrorMissing: 'Please enter your name and email address.',
      subscribeErrorInvalidEmail: 'Enter a valid email address.',
      subscribeSuccessFallback: 'You are subscribed for event email updates.',
  ...
  pcm: {
    ...
    footer: {
      ...
      description:
        'We be active youth fellowship for Foursquare Gospel Church, Mgbuoba Zonal HQ. We dey raise young people wey sabi God and dey make am known.',
      quickLinks: 'Quick Links',
      resources: 'Resources',
      serviceTimes: 'Service Times',
      firstSunday: '1st Sunday:',
      ...
      wednesdayTime: '5:00 PM (Coming Soon)',
      emailUpdates: 'Email Updates',
      emailUpdatesDesc: 'Get event gist and ministry updates for email.',
      yourName: 'Your name',
      emailAddress: 'Email address',
      subscribe: 'Subscribe',
      saving: 'Saving...',
      ...
      rightsReserved: 'All rights reserved.',
      subscribeErrorMissing: 'Abeg put your name and email address.',
      subscribeErrorInvalidEmail: 'Abeg put correct email address.',
      subscribeSuccessFallback: 'You don subscribe for event email updates.',
